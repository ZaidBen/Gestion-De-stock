    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
         ...
         $fire = mysqli_query($conn,$sql4);
          while ($result = mysqli_fetch_assoc($fire)) {
            echo"['".$result['des_pdt']."',".$result['qte']."],";
          }
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">Totale De Produit </p>
...
<div class="row mt-4">
        <div class="col-lg-4 col-md-6 mt-4 mb-4">
           <div  id="piechart" style="width: 500px; height: 420px; ">

            </div>
          </div>
       
        <div class="col-lg-4 col-md-6 mt-7 mb-4">
