...
$sql = "SELECT id,ref_cmd, des_pdt, qte, prix_uni, client, prix_t, date_c FROM commande";
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="commande.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <div class="card-header pb-0 p-3 bg-gradient-info shadow-primary border-radius-lg pt-4 pb-3">
                  <div class="row">
                    ...
                    <div class="col-6 text-end">
                      <a class="btn bg-gradient-dark mb-0" href="ajouter.php"><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Ajouter Une Commande</a>
                    </div>
                  </div>
                </div>
            <div class="card-body px-0 pb-2">
              ...
              <form method="POST">
                ...
                <table class="table align-items-center mb-0"  >
                  <thead>
                    <tr>
                      <th class="text-uppercase text-center text-dark text-sm font-weight-bolder opacity-10">Ref De Commande</th>
                      <th class="text-uppercase text-center text-dark text-sm font-weight-bolder opacity-10">Client</th>
                      <th class="text-center text-uppercase text-dark text-sm font-weight-bolder opacity-10">Article</th>
                      <th class="text-uppercase text-center text-dark text-sm font-weight-bolder opacity-10">Quantite</th>
                      <th class="text-center text-uppercase text-dark text-sm font-weight-bolder opacity-10" >Prix Unitaire</th>

                      <th class="text-center text-uppercase text-dark text-sm font-weight-bolder opacity-10" >Prix TTC</th>
                      <th class="text-center text-uppercase text-dark text-sm font-weight-bolder opacity-10" >Date</th>
               ...
               <tbody id="myTable">
                    <tr>
                      <td  >
                        <div  class='d-flex justify-content-center'>
                          ...
                          <div class='d-flex flex-column justify-content-center'>
                            <h6 class='mb-0 text-sm text-center '><?php echo   $row["ref_cmd"] ?>                </h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div  class='d-flex justify-content-center'>
                          ...
                          <div class='d-flex flex-column justify-content-center'>
                            <h6 class='mb-0 text-sm  text-uppercase'><?php echo $row["client"] ?>          </h6>
                          </div>
                        </div>
                      </td>
                      ...
                      <div class='d-flex justify-content-center '>
                        ...
                        <div class='d-flex flex-column justify-content-center'>
                          <h6 class='mb-0 text-xs badge badge-sm bg-gradient-success'>         <?php echo   $row["des_pdt"] ?>       </h6>
                        </div>
                      </div>
                    </td>
                    <td>
                    <div class='d-flex justify-content-center'>
                      ...
                      <div class='d-flex flex-column justify-content-center'>
                        <h6 class='mb-0 text-xs'>          <?php echo $row["qte"]  ?>      </h6>
                      </div>
                    </div>
                  </td>
                  <td>
                      ...
                      <td>
                        <div class='d-flex justify-content-center'>
                          ...
                          <div class='d-flex flex-column justify-content-center'>
                            <h6 class='mb-0 text-xs badge badge-sm bg-gradient-info'>   <?php echo $row["prix_t"].",00   MAD" ?>     </h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class='d-flex justify-content-center'>
                          ...
                          <div class='d-flex flex-column justify-content-center'>
                            <h6 class='mb-0 text-xs'>   <?php echo $row["date_c"] ?>     </h6>
                          </div>
                        </div>
                      </td>
