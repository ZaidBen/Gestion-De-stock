...
$sql = "SELECT id,nom_f, email, ice,rib,ville,tel,des_pdt FROM fournisseur";
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="fournisseur.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
...
<nav class="navbar-center navbar-main navbar-expand-lg mt-4 px-0 mx-10 shadow-none border-radius-xl" >
      ...
      <div class="row">
        <div class="col-12">
          <div class="card my-4">
          <div class="card-header pb-0 p-3 bg-gradient-success shadow-primary border-radius-lg pt-4 pb-3">
                  <div class="row">
                    <div class="col-6 d-flex align-items-center">
                    <h6 class="text-white text-capitalize ps-3">Liste Des Fournisseur </h6>
                    </div>
                    <div class="col-6 text-end">
                      <a class="btn bg-gradient-dark mb-0" href="ajouter.php"><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Ajouter Un Fournisseur</a>
                    </div>
                  </div>
                </div>
            <div class="card-body px-0 pb-2">
              ...
              <form method="POST">
                ...
                <table class="table align-items-center mb-0"  >
                  <thead>
                    <tr>
                      <th class="text-uppercase text-center text-dark text-sm font-weight-bolder opacity-10">Fournisseur</th>
                      ...
                      <th class="text-center text-uppercase text-dark text-sm font-weight-bolder opacity-10">RIB</th>
               ...
               <tbody id="myTable">
                    <tr>
                      ...
                      <div class='d-flex justify-content-center '>
                        ...
                        <div class='d-flex flex-column justify-content-center'>
                          <h6 class='mb-0 text-xs badge badge-sm bg-gradient-info'>         <?php echo   $row["email"] ?>       </h6>
                        </div>
                      </div>
                    </td>
                    <td>
                  ...
                  <td>
                        <div class='d-flex justify-content-center'>
                          ...
                          <div class='d-flex flex-column justify-content-center'>
                            <h6 class='mb-0 text-xs badge badge-sm bg-gradient-success'>   <?php echo $row["ice"] ?>     </h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class='d-flex justify-content-center'>
                          ...
                          <div class='d-flex flex-column justify-content-center'>
                            <h6 class='mb-0 text-xs badge badge-sm bg-gradient-success'>    <?php echo $row["rib"] ?>          </h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class='d-flex justify-content-center'>
                          ...
                          <div class='d-flex flex-column justify-content-center'>
                            <h6 class='mb-0 text-xs'>    <?php echo $row["des_pdt"] ?>          </h6>
                          </div>
                        </div>
                      </td>
