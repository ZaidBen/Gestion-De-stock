...
$sql = "SELECT id,des_pdt, qte, ref,prix_uni,date_imp,date_exp FROM stock";
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="../client/client.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
...
<nav class="navbar-center navbar-main navbar-expand-lg mt-4 px-0 mx-10 shadow-none border-radius-xl" >
      ...
      <div class="row">
        <div class="col-12">
          <div class="card my-4">
          <div class="card-header pb-0 p-3 bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                  <div class="row">
                    <div class="col-6 d-flex align-items-center">
                    <h6 class="text-white text-capitalize ps-3">Stock Manage</h6>
                    </div>
            ...
            <div class="card-body px-0 pb-2">
              ...
              <form method="POST">
                ...
                <table class="table align-items-center mb-0"  >
                  <thead>
                    <tr>
                      <th class="text-uppercase text-center text-dark text-sm font-weight-bolder opacity-10">Désignation De Produit</th>
                      <th class="text-uppercase text-center text-dark badge badge-sm bg-gradient-success text-sm font-weight-bolder opacity-10">Quantité</th>
                      <th class="text-center text-uppercase text-dark text-sm font-weight-bolder opacity-10">Référence</th>
                      <th class="text-uppercase text-center text-dark text-sm font-weight-bolder opacity-10">Prix Unitaire</th>

                      <th class="text-center text-uppercase badge badge-xxs bg-gradient-info  text-dark text-sm font-weight-bolder opacity-10">Date d'Impoportaion</th>
                      <th class="text-center text-uppercase text-dark text-sm font-weight-bolder opacity-10">Date d'Exportation</th>
               ...
               <tbody id="myTable">
                    <tr>
                      <td  >
                        <div  class='d-flex justify-content-center'>
                          ...
                          <div class='d-flex flex-column justify-content-center'>
                            <h6 class='mb-0 text-sm-center'><?php echo   $row["des_pdt"] ?>                </h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div  class='d-flex justify-content-center'>
                          ...
                          <div class='d-flex flex-column justify-content-center'>
                            <h6 class='mb-0 text-xs badge badge-sm bg-gradient-success'><?php echo $row["qte"] ?>          </h6>
                          </div>
                        </div>
                      </td>
                      ...
                      <div class='d-flex justify-content-center '>
                        ...
                        <div class='d-flex flex-column justify-content-center'>
                          <h6 class='mb-0 text-xs'>         <?php echo   $row["ref"] ?>       </h6>
                        </div>
                      </div>
                    </td>
                    <td>
                    <div class='d-flex justify-content-center'>
                      ...
                      <div class='d-flex flex-column justify-content-center'>
                        <h6 class='mb-0 text-xs'>          <?php echo   $row["prix_uni"] .",00   MAD" ?>      </h6>
                      </div>
                    </div>
                  </td>
                  <td>
                        <div class='d-flex justify-content-center'>
                          ...
                          <div class='d-flex flex-column justify-content-center'>
                            <h6 class='mb-0 text-xs badge badge-sm bg-gradient-info'>   <?php echo $row["date_imp"] ?>     </h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class='d-flex justify-content-center'>
                          ...
                          <div class='d-flex flex-column justify-content-center'>
                            <h6 class='mb-0 text-xs'>    <?php echo $row["date_exp"] ?>          </h6>
                          </div>
                        </div>
                      </td>
                      <div class='d-flex justify-content-center'>
